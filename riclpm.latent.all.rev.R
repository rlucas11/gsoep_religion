...
## Source model files
source("scripts/fullRiclpm.rev.R")      ## Lavaan model name is 'model1_riclpmMod
...
write_csv(riclpm.aggregated.estimates, file="results/riclpm.latent.states.aggregated.estimates.rev.csv")
save(riclpm.warnings, file="results/riclpm.warnings.rev.RData")
save(riclpm.errors, file="results/riclpm.errors.rev.RData")
...
## Save matrix of results
write_csv(riclpm.aggregated.fit, file="results/riclpm.latent.states.aggregated.fit.rev.csv")           

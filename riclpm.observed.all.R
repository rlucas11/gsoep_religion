...
source("scripts/riclpmObserved.R")   ## Lavaan model name: riclpm_observed
...
write_csv(riclpm.aggregated.estimates, file="results/riclpm.observed.states.aggregated.estimates.csv")
save(riclpm.warnings, file="results/riclpm.observed.warnings.RData")
save(riclpm.errors, file="results/riclpm.observed.errors.RData")

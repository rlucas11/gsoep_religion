...
dataC <- read_csv("results/clpm.latent.states.aggregated.estimates.rev.csv")
dataRi <- read_csv("results/riclpm.latent.states.aggregated.estimates.rev.csv")
...
write.csv(data.frame(combinedResults), "data/combinedResults.rev.csv", row.names=FALSE)

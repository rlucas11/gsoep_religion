## Source model files
source("scripts/clpmObserved.R") ## Lavaan model name: clpm_observed
...
write_csv(clpm.aggregated.estimates, file="results/clpm.observed.states.aggregated.estimates.csv")
save(clpm.warnings, file="results/clpm.observed.warnings.RData")
save(clpm.errors, file="results/clpm.observed.errors.RData")
...
write_csv(clpm.aggregated.fit, file="results/clpm.observed.states.aggregated.fit.csv")           

...
@entringer_big_2023 also found moderating effects of state-level religiosity for the paths from religiosity to openness, but the paths to the other traits were not significant. Figure \@ref(fig:moderator-meta-tr) shows that this one significant path also emerged in our version of this model. Again, however, when the RI-CLPM was used, the meta-analytic effect became non-significant (and indeed, reversed sign). Thus, consistent with the full-sample analyses, we found no moderating effects of state-level religion that consistently emerged across model specifications. 
